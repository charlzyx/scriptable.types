...
*/
  ...
  */
  ...
  /**
  * Adds an action to the alert.Adds an action button to the alert. To check if an action was selected, you should use the first parameter provided when the promise returned by presentAlert() and presentSheet() is resolved.
  * Parameters¶
  * title
  * string
  * Title of the action.
...
*/
  ...
  */
  static schedule(timeInterval: number, repeats: boolean, callback: () => {}): Timer;
}/** ---------UITable --------
  Renders a table.
